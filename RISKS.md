...
- Regeneration reads executed flat deployment records and retains current, previous, and v1 generations; a mainnet proposal never supplies an active contract address.
